...
public class HUD : MonoBehaviour
{
    ...
    private enum ImagesName { SpeedBar, FuelBar, TemperatureBar, Slot1, Slot2, Resume, Garage, Confirm, Yes, No, WindDirection, Medal, ResultMedal, RestartResult, GarageResult, EngineValue };
