...
public class TextContainer
{
    ...
    public static readonly string[] CARS_DESCRIPTIONS = { "Small, tapered and fast, a great single-seat for sneaking in the smallest place that are in Mars.",
    ...
    public static readonly string[] ACCESSORY1_DESCRIPTIONS = { "Increase fuel amount in storm.",

                                                                 "Increase fuel amount in sunny area.",

                                                                 "Increase fuel amount in geomagnetic storm.",
    ...
    public static readonly string[] ACCESSORY2_DESCRIPTIONS = { "Increase fuel amount in storm.",
                                                                 ...
                                                                 "Made for break the martian speed limits.it gives you a good boost for a short time.",
